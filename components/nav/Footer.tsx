            ...
            <ul className="space-y-3">
              ...
              {['8600241900','9552319748','8485878785','9923309468'].map(num => (
                <li key={num} className="flex items-center gap-2">
                  ...
                  <a href={`tel:${num}`} className="text-brand-silver text-sm hover:text-brand-gold transition-colors">
                    {num}
                  </a>
                </li>
              ))}
              <li className="flex items-center gap-2">
                <Icon icon="mdi:instagram" width={16} height={16} className="text-brand-gold flex-shrink-0" />
                <a href="https://instagram.com/ucci_muslimbizclub" target="_blank" rel="noopener noreferrer" className="text-brand-silver text-sm hover:text-brand-gold transition-colors">
                  ucci_muslimbizclub
                </a>
              </li>
            </ul>
